...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/03/11 10:43:50 by mberedda          #+#    #+#             */
/*   Updated: 2016/03/18 17:23:50 by mberedda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_color(int x, int y, t_env *e, int direct)
{
	...
	if (calc == 0)
		ft_put_pixel(e, x, y, 0x5555FF);
	else if (calc < 2)
		ft_put_pixel(e, x, y, 0x555555);
	else if (calc < 4)
		ft_put_pixel(e, x, y, 0xFF5555);
	else if (calc < 8)
		ft_put_pixel(e, x, y, 0x00AAAA);
	else if (calc < 16)
		ft_put_pixel(e, x, y, 0x00AA00);
	else if (calc < 32)
		ft_put_pixel(e, x, y, 0x427999);
	else if (calc < 64)
		ft_put_pixel(e, x, y, 0xFFFF55);
	else if (calc < 128)
